    ...
    <style>
        ...
        * {
        ...
        .sidebar {
            ...
            color: var(--white);
            padding: 20px 0;
            box-shadow: 2px 0 10px var(--shadow-blue);
            position: fixed;
            height: 100vh;
            left: 0;
            top: 0;
        ...
        .stat-card {
            background: linear-gradient(135deg, var(--white) 0%, #f8fcff 100%);
            padding: 25px;
            border-radius: 16px;
            box-shadow: 0 8px 32px rgba(0, 0, 0, 0.1);
            text-align: center;
...
<body>
    ...
    <nav class="sidebar">
        <div class="sidebar-header">
            <div class="sidebar-logo">
                <div class="logo">
                    <div class="logo-inner"><img src="../../images/logo.png" alt="Logo"></div>
                </div>
                <div class="sidebar-title">Instructor Portal</div>
            </div>
        </div>
    ...
    <main class="main-content">
            ...
            <div class="content-card">
                <div class="time-controls">
                    <div class="time-selector">
                        ...
                        <button class="time-btn" data-timeframe="custom">Custom Range</button>
                    </div>
        ...
        <div class="page" id="student-analytics">
            <div class="page-header">
                <h1 class="page-title">Student Analytics</h1>
                <p class="page-subtitle">Detailed attendance patterns and insights</p>
            </div>
            <div class="content-card">
        ...
        <div class="page" id="class-management">
            ...
            <div class="content-card">
                <p>Class management tools coming soon...</p>
            </div>
        </div>
        ...
        <div class="page" id="reports">
            ...
            <div class="content-card">
                <p>Report generation tools coming soon...</p>
            </div>
        </div>
        ...
        <div class="page" id="logout">
            ...
            <div class="content-card" style="text-align: center;">
                ...
                <div style="display: flex; gap: 15px; justify-content: center;">
                    <button class="btn btn-danger" id="confirm-logout">Yes, Logout</button>
